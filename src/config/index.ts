...
export const DB_LIQUIDITY_PATH = path.join(DB_PATH, "/src/db/liquidity.json");
export const DB_TOKENS_PATH = path.join(DB_PATH, "/src/db/tokens.json");
export const DB_PAIRS_PATH = path.join(DB_PATH, "/src/db/pairs.json");
